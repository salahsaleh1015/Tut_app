...
class _AppServiceClient implements AppServiceClient {
  _AppServiceClient(
    ...
    baseUrl ??= 'https://ezr56.wiremockapi.cloud/';
  }
  ...
  Future<HomeDetailsResponse> getHomeDetailsData() async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HomeDetailsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = HomeDetailsResponse.fromJson(_result.data!);
    return value;
  }
