...
class _$RegisterObjectImpl implements _RegisterObject {
  _$RegisterObjectImpl(this.userName, this.countryCode, this.phoneNumber,
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, countryCode: $countryCode, phoneNumber: $phoneNumber, email: $email, password: $password, profilePicture: $profilePicture)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userName, countryCode,
      phoneNumber, email, password, profilePicture);
...
class _$ForgetPasswordObjectImpl implements _ForgetPasswordObject {
  _$ForgetPasswordObjectImpl(this.userName);
  ...
  @override
  String toString() {
    return 'ForgetPasswordObject(userName: $userName)';
  }
...
abstract class _ForgetPasswordObject implements ForgetPasswordObject {
  factory _ForgetPasswordObject(final String userName) =
